...
class Spec extends SpecBase {
  ...
  // Fall 2021
  test(run("((-1 / (2 + -1)) * (3 % 2))"), "-1")
  test(run("((3 + (2 + 1)) / ((3 % 1) + 3))"), "2")
  test(run("(((1 + 1) + (-1 * -1)) % ((-1 / 1) + (1 * 3)))"), "1")
  test(run("(((1 + 1) + (2 * 0)) * ((3 / 3) / 1))"), "2")
  test(run("(((3 / 2) % 3) + ((3 + 2) + 3))"), "9")
  test(run("{ if ({ if ((2 == -1)) (-1 == 1) else { if (true) true else false } }) { if ((3 < 2)) (3 + 3) else { if (true) 3 else 2 } } else ({ if (true) 3 else 2 } + (1 / 3)) }"), "3")
  test(run("({ if ((1 == 2)) { if (false) 1 else 2 } else { if (false) -1 else 1 } } / { if ({ if (true) false else false }) (2 / 1) else { if (false) 1 else 1 } })"), "1")
  test(run("({ if ((2 == 1)) { if (true) 1 else 3 } else (3 * 1) } * { if ((0 == 1)) { if (false) -1 else 2 } else (1 % 2) })"), "3")
  test(run("{ if (((1 + 2) < (3 % 1))) ((2 / 1) * { if (false) 1 else 2 }) else ((1 % 2) + (1 % 2)) }"), "2")
  test(run("({ if ((3 < 2)) 3 else (0 / 3) } + ((-1 / 1) + (2 % 3)))"), "1")
  test(run("((2, 2, 1)._2, (1, 1)._2, (2 / 1))._3"), "2")
  test(run("((2, 2, 3)._2, 2, (2, 3, 2, 3)._3)._1"), "2")
  test(run("((1, 3, 3, 2)._4, (3, -1, 3, 2)._3)._1"), "2")
  test(run("((3, 3)._1 + ((0, 3, 0)._3 / (3 / -1)))"), "3")
  test(run("((1, 3)._2 + ((3, 3, 3), 2)._1._3)"), "6")
  test(run("((3 :: Nil) :: ((2 :: Nil) :: Nil)).tail.head.head"), "2")
  test(run("((2 :: Nil).head :: (-1 :: (3 :: Nil))).tail.head"), "-1")
  test(run("{ if (((3 / 3) :: (3 :: Nil).tail).isEmpty) (({ if (false) 2 else 3 } * (1 :: Nil).head) + ((1 :: Nil).head % -1)) else ((3 :: Nil) :: Nil).head.head }"), "3")
  test(run("{ if ((0 :: (3 :: Nil)).isEmpty) (Nil :: Nil).head.tail else (2 :: (1 :: Nil)).tail }.head"), "1")
  test(run("{ if ({ if (true) (3 :: Nil) else (2 :: Nil) }.tail.isEmpty) ((2 :: Nil).head * ((2 / 1) / (2 / 2))) else ((2 :: (3 :: Nil)).head + ((2 :: Nil).head / (3 / 1))) }"), "4")
  test(run("{ val x = (1 + (3 + 2)); ({ val w = x; -1 } + (0 * x)) }"), "-1")
  test(run("({ val t = { val z = 0; 2 }; 3 } + { val x = (2 % 2); (3 * 2) })"), "9")
  test(run("{ val u = { val u = { val v = 2; 3 }; { val y = u; u } }; { val y = { val v = u; u }; { val w = y; w } } }"), "3")
  test(run("{ val q = { val z = { val s = 3; s }; { val w = z; z } }; { val y = (3 / q); (q / y) } }"), "3")
  test(run("{ val x = ({ val x = -1; x } / (3 % 2)); ({ val r = 1; 1 } * { val w = x; w }) }"), "-1")
  test(run("(() => ((r) => ((t, z) => z)))()(3)(((2 / 1) * (2 % 2)), ((z) => z)(((u) => u)(1)))"), "1")
  test(run("((s) => ((y, r) => (() => r)))(2)(3, (3 / 2))()"), "1")
  test(run("((t) => (() => t))((0 + 2))()"), "2")
  test(run("((((v, q, y) => q)(2, 2, 1) + ((q, v) => q)(3, 3)) * ((2 * 2) * (1 + 2)))"), "60")
  test(run("((z, s) => z)((((x, y) => x)(-1, 3) * (3 + 3)), ((1 * 1) * (0 * 3)))"), "-6")
  test(run("{ def y(v, t) = t(v, v); def t(q, z) = { def r(w, y) = y; r }; def s(z, x) = ((t, u) => 1)(-1, x); y(2, s) }"), "1")
  test(run("{ def z(u, x) = (u * 1); def v(z) = z(3, 3); v(z) }"), "3")
  test(run("{ def z(w) = ((r, q, w) => w)(w, w, 2); def y(r, t) = r(t); y(z, 0) }"), "2")
  test(run("{ def v(u, w) = ((w, v) => 2)(2, 3); def x(u) = u(); def r(q, x) = x(q, q); r(-1, v) }"), "2")
  test(run("{ def s(x, r) = r(x); def u(q) = ((x, y) => 1)(2, q); def r(u) = ((z, u, t) => u)(1, u, 3); s(3, u) }"), "1")
  test(run("{ def x(z, y) = { if ((y < 0)) (z + y) else { if ((2 < y)) (x((y + z), (y + -2)) * x(2, (y + -1))) else x((z * 1), (y + -1)) } }; x(6, 5) }"), "260")
  test(run("{ def r(u) = { if ((u < 1)) 1 else { if ((u == 3)) (r((u + -2)) * (4 * u)) else (q((u + -1), (1 * u)) * q((u + -1), (2 * u))) } }; def q(s, z) = { if ((s < 0)) (s * 2) else { if ((s == z)) r((s + -1)) else (4 + r((s + -3))) } }; r(9) }"), "714025")
  test(run("{ def x(t, w) = { if ((w < 3)) 3 else { if ((w < 1)) v((2 * t), (w + -2)) else v((w + 1), (w + -3)) } }; def v(z, y) = { if ((y < 1)) (z * y) else { if ((z < y)) (v(3, (y + -1)) + v((3 * y), (y + -1))) else (x(3, (y + -2)) * 4) } }; v(7, 9) }"), "180")
  test(run("{ def z(y, r) = { if ((y < 2)) 1 else { if ((2 == r)) (z((y + -3), 2) * (y * 3)) else (0 * q((y + -2))) } }; def v(t, y) = { if ((t < 3)) 3 else { if ((4 == t)) z((t + -1), 1) else (q((t + -3)) * v((t + -2), (t + 4))) } }; def q(r) = { if ((r < -1)) 1 else { if ((r == 0)) v((r + -3), (r + 4)) else (q((r + -3)) + v((r + -3), 1)) } }; v(9, 7) }"), "6615")
  test(run("{ def w(v, y) = { if ((v < 1)) (1 * v) else { if ((2 == y)) (0 + z((v + -1))) else r((v + -3)) } }; def r(t) = { if ((t < 1)) (2 + t) else { if ((1 < t)) (z((t + -2)) + w((t + -2), 0)) else (r((t + -1)) * 0) } }; def z(u) = { if ((u < 1)) (0 + u) else { if ((u == 0)) (z((u + -3)) * r((u + -2))) else (z((u + -2)) * r((u + -3))) } }; r(9) }"), "1")
  test(run("{ vcc x; ({ vcc x; x(2) } * 3) }"), "6")
  test(run("((x) => x)({ vcc t; t((1 / -1)) })"), "-1")
  test(run("{ vcc z; { vcc w; ((1 / 3) * w(1)) } }"), "1")
  test(run("{ vcc r; (((0 / 2) * (2 / 2)) / r({ vcc z; 2 })) }"), "2")
  test(run("(({ vcc t; (() => 2) }() * { vcc s; ((w, s, u) => 3) }((1 + 3), (1 + 2), ((q) => 2)(2))) * ({ vcc w; w(3) } / ((2 / 2) % ((t) => t)(3))))"), "18")
  test(run("((((3 * 3) * (3 * 1)) + 3) * { vcc z; z({ vcc x; 2 }) })"), "60")
  test(run("{ try { throw ({ throw 0 } / 2) } catch ((u, y, q) => ((t) => 2))((2 / 1), (3 + 2), (1 / 2)) }"), "2")
  test(run("((u) => ((v) => ((u, y) => 3)))(2)({ try { throw -1 } catch ((v) => 2) })(((y) => 3)({ try ((y, w) => 2) catch ((w) => ((v, y) => 1)) }), 1)"), "3")
  test(run("{ try ({ throw 1 } / 1) catch ((s) => s) }"), "1")
  test(run("{ try ((s, r) => { throw s })({ try 1 catch ((y) => y) }, ((r, v) => v)(2, 3)) catch ((x) => 2) }"), "2")
  test(run("{ try (((r) => r)(1) / ((w, q, s) => s)({ throw 2 }, 2, 1)) catch ((x) => { try x catch ((z) => z) }) }"), "2")
  test(run("{ try { throw 3 }(((q, y, u) => y)(3, 1, { throw 2 }), { try 1 catch ((s) => s) }, ({ throw 2 } * 3)) catch { try ((q, x) => ((u) => q)) catch ((y) => ((u, w) => ((w) => y))) }((3 / 1), (2 / 2)) }"), "3")
  test(run("(((0, (1 :: Nil), false, 1), ((q, y) => -1)), (2, 2, true))._1._2(((w) => ((false, w) :: Nil))(1).head, { try ((t, v, u) => { throw Nil })(0, Nil, 1) catch ((s) => (true, true)) })"), "-1")
  test(run("((y, u) => 2)({ try { throw (2, true) } catch ((x) => ((3 :: Nil) :: Nil)) }.isEmpty, (() => Nil)().isEmpty)"), "2")
  test(run("{if ((3 :: Nil).isEmpty) { val u = false; (1, 3, (u, 2, false), 3) } else { try ({ throw 3 }, 3, (false, 3, { throw 3 }), { throw 1 }) catch ((y) => (3, y, (false, y, true), 2)) } }._4"), "2")
  test(run("{ def s(r) = (((s) => (r, 2, false)), ((s, q) => false), ((((false, false) :: Nil), false, false) :: Nil)); (3, ((z) => 2), 3, 2)._2 }({ try ((q, u) => false)({ throw -1 }, 0) catch ((q) => true) })"), "2")
  test(run("{ try {if (true) ({ throw 2 }, 3) else { throw 3 } } catch { def w(s, v) = v; def t(q) = q; def s(t) = false; ((u) => (u, 2)) } }._1"), "2")
  test(run("{if ({ vcc y; y(true) }) { val u = { val v = (3 :: Nil); 1 }; (3 :: Nil).head } else {if ((0 :: Nil).isEmpty) (-1, -1)._2 else (2 :: Nil).head } }"), "3")
  test(run("{ try { throw ((v, s) => (3, true, ((() => ((2, (1 :: Nil)), false)), (1, 3), 3), true)) }() catch { val x = 1; ((r) => ((x :: Nil), 3)) } }._2"), "3")
  test(run("{ vcc q; { try q(2) catch (((y) => 2), ((false :: Nil), 2, ((w, t) => t), true))._1 } }"), "2")
  test(run("{ try { def t() = Nil; (3, (true, true, true), Nil, ({ throw true }, { throw true }, 3)) } catch { val r = ((2, 1, false) :: Nil); ((u) => (2, (false, false, u), (u :: Nil), (3, 2, 3))) } }._1"), "2")
  test(run("{ try { throw 1 }.head catch ((q) => { val y = (((q, s, t) => true), ((q :: Nil), Nil, true, (true, 1))); q }) }"), "1")
  test(run("{if ({if (false) ((q, x) => x) else ((w, z) => z) }({ try 1 catch ((x) => 2) }, (3 :: Nil).isEmpty)) {if (false) 3 else 2 } else { vcc x; x(3) } }"), "3")
  test(run("{ try {if ({ val q = false; q }) { throw (() => (3 :: Nil)) }((1 :: Nil)) else { val x = { throw (() => (0 :: Nil)) }; 2 } } catch ((y, s) => (((u) => 3) :: Nil))(1, 2).head }"), "3")
  test(run("{ val r = { try { throw Nil } catch ((r) => 1) }; { try ((x) => 3) catch ((s) => ((y) => r)) } }({if ({ vcc q; true }) {if (false) -1 else 1 } else (2, 3, (((false :: Nil) :: Nil) :: Nil))._2 })"), "3")
  test(run("{ val v = { vcc q; q(false) }; ((3, 2) :: Nil).head._2 }"), "2")
  test(run("{ try { def s(q) = (2 :: Nil).head; { throw 2 } } catch {if ({if (true) true else false }) (() => ((y) => y))() else { val y = 1; ((x) => 2) } } }"), "2")
  testExc(run("x"), "")
  testExc(run("(x => 0)(x)"), "")
  testExc(run("(x => x)(true) + 1"), "")
  testExc(run("1 + (x => x)(true)"), "")
  testExc(run("(x => x)(true) * 1"), "")
  testExc(run("1 * (x => x)(true)"), "")
  testExc(run("1 / (x => x)(0)"), "")
  testExc(run("(x => x)(true) / 1"), "")
  ...
  testExc(run("(x => x)(true) == 1"), "")
  testExc(run("1 == (x => x)(true)"), "")
  testExc(run("(x => x)(true) == (x => x)(true)"), "")
  testExc(run("(x => x)(true) < 1"), "")
  testExc(run("1 < (x => x)(true)"), "")
  testExc(run("if ((x => x)(1)) 1 else 1"), "")
  testExc(run("(x => x)((1, 1))._3"), "")
  testExc(run("(x => x)(1)._1"), "")
  testExc(run("1 :: (x => x)(1)"), "")
  testExc(run("(x => x)(1).isEmpty"), "")
  testExc(run("(x => x)(Nil).head"), "")
  testExc(run("(x => x)(1).head"), "")
  testExc(run("(x => x)(Nil).tail"), "")
  testExc(run("(x => x)(1).tail"), "")
  testExc(run("(x => x)((a, b) => a + b)(1)"), "")
  testExc(run("(x => x)((a, b) => a + b)(1, 1, 1)"), "")
  testExc(run("(x => x)(1)()"), "")
  testExc(run("val f = () => y; val y = 1; f()"), "")
  test(run("{ val y = false; { def r(v) = ((s, x) => v)(y, v); r(y) } }"), "false")
  test(run("{ def r() = 1; ((v, r, y) => r) }(false, 1, -1)"), "1")
  testExc(run("((x, y) => Nil)(false)"), "")
